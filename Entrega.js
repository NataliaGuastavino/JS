...
class Actividad{
    constructor (id, nombreActividad, costo) {
        this.id = id,
...
const campNou = new Actividad (1, "Camp Nou", 70)
const casaBattlo = new Actividad (2, "Casa Battló", 60)
const casaMila = new Actividad (3, "Casa Milá", 40)
const casaPedrera = new Actividad (4, "Casa de la Pedrera", 50)
const parkGuell = new Actividad (5, "Park Guell", 30)
const sagradaFamilia = new Actividad (6, "Sagrada Familia", 90)


// Creo el array de actividades y pusheo los objetos ya existentes:
const listaActividades = []
listaActividades.push (campNou, casaBattlo, casaMila, casaPedrera, parkGuell, sagradaFamilia)
